...
def train_and_save(hyperparameters: Hyperparameters):
    if os.path.exists(
        f"lab05/models/td3_lunarlander_v2_{hyperparameters}_5"
    ):
        print(
    ...
    for i in range(5):
        ...
        model.save(f"lab05/models/td3_lunarlander_v2_{hyperparameters}_{i+1}")
...
for hyperparameters in [
    Hyperparameters(gamma=0.99, learning_rate=3e-4, noise_sigma=0.5, timesteps=200_000),
    Hyperparameters(gamma=0.95, learning_rate=2e-4, noise_sigma=0.4, timesteps=200_000),
    Hyperparameters(gamma=0.90, learning_rate=1e-4, noise_sigma=0.3, timesteps=200_000),
]:
